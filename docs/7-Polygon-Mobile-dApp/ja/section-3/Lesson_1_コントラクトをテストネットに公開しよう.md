...
![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_01.png)

下記のようなポップアップが立ち上がったら、`Switch Network` をクリックしましょう。

![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_02.png)

`Matic Mainnet` があなたの MetaMask にセットアップされました。

![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_03.png)
...
![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_04.png)
...
![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_05.png)

下の画像で示す部分をクリックすると、`HTTP`を確認できます。

![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_06.jpg)
...
![](/public/images/7-Polygon-Mobile-dApp/section-3/3_1_07.png)
