...
![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_1.png)
...
![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_2.png)

次に `Import Account` と書いてあるボタンを押して Ganache のアカウントをインポートしていきます。

![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_3.png)

`Import Account` を選択すると、`Private Key` を入力するよう求められます。

![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_4.png)
...
![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_5.png)
...
![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_6.png)

自分が使用している Metamask のアカウントが黄色くハイライトされていることがわかります。
自分が使用しているアカウントの下にある `Connect` を押せばフロントエンドとMetamaskの接続が完了します！

![](/public/images/12-Ganache-Yield-Farm/section-1/12_3_7.png)
