...
![](/images/ETH-NFT-Game/section-1/1_2_1.png)

2. Create a new forkページが開くので、「Copy the `main` branch only」という項目に**チェックが入っていることを確認します**。

![](/images/ETH-NFT-Game/section-1/1_2_2.png)
...
![](/images/ETH-NFT-Game/section-1/1_2_3.png)
...
![](/images/ETH-NFT-Game/section-1/1_2_4.png)
