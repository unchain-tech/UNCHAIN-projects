...
![無題](/public/images/7-Solana-NFT-drop/section4/4_2_1.png)

3 \. Web アプリケーションのリポジトリを `Import` してください。

![無題](/public/images/7-Solana-NFT-drop/section4/4_2_2.png)
...
![無題](/public/images/7-Solana-NFT-drop/section4/4_2_3.png)

環境変数 `CI = false` を追加することにより、警告が原因でビルドが失敗しないようになります。

![無題](/public/images/7-Solana-NFT-drop/section4/4_2_4.png)
