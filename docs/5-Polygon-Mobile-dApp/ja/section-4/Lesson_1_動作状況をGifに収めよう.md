...
![](/public/images/5-Polygon-Mobile-dApp/section-4/4_1_01.gif)
...
![](/public/images/5-Polygon-Mobile-dApp/section-4/4_1_02.png)

リポジトリに名前を付けたら、`Create repository` ボタンを押してください。

次に、ディレクトリのリンクをコピーしましょう。

![](/public/images/5-Polygon-Mobile-dApp/section-4/4_1_03.png)
