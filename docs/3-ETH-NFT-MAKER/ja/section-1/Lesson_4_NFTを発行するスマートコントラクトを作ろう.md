...
1 行ずつコードを見ていきたいですが、ほとんどは[Project2-section1-lesson4](https://unchain-portal.netlify.app/projects/2-ETH-NFT-collection/section-1-Lesson-4)で解説されているので、今回はポイントに絞って解説したいと思います。解説されていなくてわからない方はぜひ一度戻ってみることをおすすめします。
...
![](/public/images/3-ETH-NFT-MAKER/section1/1-4-1.png)
...
![](/public/images/3-ETH-NFT-MAKER/section1/1-4-2.png)
...
![](/public/images/3-ETH-NFT-MAKER/section1/1-4-3.png)
次に、下記の項目を埋めていきます。下図を参考にしてください。
![](/public/images/3-ETH-NFT-MAKER/section1/1-4-4.png)
- `NAME` : プロジェクトの名前（例: `Web3NFT`）
- `DESCRIPTION` : プロジェクトの概要（任意）
- `CHAIN` : `Ethereum` を選択。
- `NETWORK` : `Rinkeby` を選択。
それから、作成した App の `VIEW DETAILS` をクリックします。
![](/public/images/3-ETH-NFT-MAKER/section1/1-4-5.png)
プロジェクトを開いたら、`VIEW KEY` ボタンをクリックします。
![](/public/images/3-ETH-NFT-MAKER/section1/1-4-6.png)
...
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_7.png)
>
> 2 \. `Show/hide test networks` をクリック。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_8.png)
>
> 3 \. `Show test networks` を `ON` にする。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_9.png)
>
> 4 \. `Rinkeby Test Network` を選択する。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_10.png)
...
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_11.png)
>
> 2\. それから、`Account details` を選択してください。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_12.png)
>
> 3\. `Account details` から `Export Private Key` をクリックしてください。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_13.png)
>
> 4\. MetaMask のパスワードを求められるので、入力したら `Confirm` を推します。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_14.png)
>
> 5\. あなたの秘密鍵（＝ `Private Key` ）が表示されるので、クリックしてコピーします。
>
> ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_15.png)
>
...
>
> - ユーザー名: 公開アドレス
>   ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_16.png)
>
> - パスワード: 秘密鍵
>   ![](/public/images/3-ETH-NFT-MAKER/section1/1_4_17.png)
>
...
ターミナルに出力された `Contract deployed to` に続くアドレスを検索してみましょう。
![](/public/images/3-ETH-NFT-MAKER/section1/1_4_18.png)
`TanyaNFT` をクリックしてみましょう。
![](/public/images/3-ETH-NFT-MAKER/section1/1_4_19.png)
コレクションが Rarible に表示されているのを確認してください。
![](/public/images/3-ETH-NFT-MAKER/section1/1_4_20.png)
