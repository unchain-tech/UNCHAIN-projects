...
![](/public/images/3-ETH-NFT-MAKER/section3/3-2-1.png)
...
![](/public/images/3-ETH-NFT-MAKER/section3/3-2-2.png)

そこで、Web サイトとあなたのウォレットアドレスの接続を一度解除します。

- `Disconnect this account` を選択してください。

![](/public/images/3-ETH-NFT-MAKER/section3/3-2-3.png)
...
![](/public/images/3-ETH-NFT-MAKER/section3/3-2-4.png)

では、`Connect Wallet` ボタンを押してみましょう。

下図のように MetaMask からウォレット接続を求められますので、承認してください。

![](/public/images/3-ETH-NFT-MAKER/section3/3-2-5.png)
