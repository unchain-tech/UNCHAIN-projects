...
![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_1.png)
...
![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_2.png)
...
![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_3.png)
...
![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_4.png)

リポジトリに、`nft-collectible-frontend-git` と名前を付け足ら、`Create repository` ボタンを押してください。

次に、ディレクトリのリンクをコピーしましょう。

![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_6.png)
...
![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_7.png)

2\. `Import Git Repository` で自分の GitHub アカウントを接続したら、`nft-collectible-frontend-git` を選択し、`Import` してください。

![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_8.png)

3\. プロジェクトを作成します。Environment Variable に下記を追加します。

`NAME`＝`CI`、`VALUE`＝`false`（下図参照）

![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_9.png)
...
![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_10.png)

デプロイが完了したら、自分の Web サイトに向かい、NFT を Mint してみましょう。

![](/public/images/5-Polygon-Generative-NFT/section-4/4_2_11.png)
