...
![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_1.png)

次に、下記の項目を埋めていきます。下図を参考にしてください。

![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_2.png)
...
![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_3.png)

プロジェクトを開いたら、`VIEW KEY` ボタンをクリックします。

![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_4.png)
...
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_5.png)
>
> 2 \. `Show/hide test networks` をクリック。
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_6.png)
>
> 3 \. `Show test networks` を `ON` にする。
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_7.png)
>
> 4 \. `Rinkeby Test Network` を選択する。
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_8.png)
...
>
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_9.png)
>
> 2\. それから、`Account details` を選択してください。
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_10.png)
>
> 3\. `Account details` から `Export Private Key` をクリックしてください。
>
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_11.png)
>
> 4\. MetaMask のパスワードを求められるので、入力したら `Confirm` を推します。
>
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_12.png)
>
> 5\. あなたの秘密鍵（＝ `Private Key` ）が表示されるので、クリックしてコピーします。
>
> ![](/public/images/5-Polygon-Generative-NFT/section-2/2_2_13.png)
>
