...
![](/images/NEAR-MulPay/section-2/2_3_1.png)

デスクトップ版であれば下のような画面が表示されていれば成功です。
![](/images/NEAR-MulPay/section-2/2_3_3.png)
...
正常に動いていれば、エミュレータの場合下のように表示されるはずです！
![](/images/NEAR-MulPay/section-2/2_3_2.png)

デスクトップ版であれば下のような画面が表示されていれば成功です。
![](/images/NEAR-MulPay/section-2/2_3_4.png)
