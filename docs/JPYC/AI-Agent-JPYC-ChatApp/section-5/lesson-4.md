...
このレッスンでは、設定モーダルとプロフィール・友達リスト管理UIを実装します。
...
設定モーダルと共存できるように、適切にレイアウトされています。
...
すると以下のようなチャットアプリが立ち上がるはずです！

![](/images/AI-Agent-JPYC-ChatApp/section-5/5_4_0.png)
