...
![new project](/public/images/10-Solana-Online-Store/ja/section-4/4_1_1.png)

2\. `Import Git Repository` で自分の GitHub アカウントを接続したら、Web アプリケーションのリポジトリを `Import` してください。

![Import](/public/images/10-Solana-Online-Store/ja/section-4/4_1_2.png)
...
![Environment Variables1](/public/images/10-Solana-Online-Store/ja/section-4/4_1_3.png)

![Environment Variables2](/public/images/10-Solana-Online-Store/ja/section-4/4_1_4.png)
