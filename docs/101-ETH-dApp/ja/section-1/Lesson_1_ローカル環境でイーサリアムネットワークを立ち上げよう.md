...
このアドレスは、Hardhat がブロックチェーン上のユーザーを特定するために生成するイーサリアムアドレスです。イーサリアムアドレスに関しては、あとで詳しく説明します。
...
![](/public/images/101-ETH-dApp/section-1/1_1_1.png)
...
1. 1 つ上の階層のフォルダー（`my-wave-portal`）に移動: `cd ..`
