...
このプロジェクトでは、イーサリアムサイドチェーンのPolygon 上に支払い機能を持ったドメインネームサービスアプリを実装し、実際にミントして使いこなすことを目的とします。
...
CoolDomains と呼ばれる **ブロックチェーン上でドメインネームサービス** を構築します。

CoolDomains では、以下の機能を実装します。
