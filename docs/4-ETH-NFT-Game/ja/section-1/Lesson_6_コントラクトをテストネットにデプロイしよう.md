...
![](/public/images/4-ETH-NFT-Game/section-1/1_5_1.png)

次に、下記の項目を埋めていきます。下図を参考にしてください。

![](/public/images/4-ETH-NFT-Game/section-1/1_5_2.png)
...
![](/public/images/4-ETH-NFT-Game/section-1/1_5_3.png)

プロジェクトを開いたら、`VIEW KEY` ボタンをクリックします。

![](/public/images/4-ETH-NFT-Game/section-1/1_5_4.png)
...
>
> ![](/public/images/4-ETH-NFT-Game/section-1/1_5_5.png)

> 2 \. `Show/hide test networks` をクリック。
>
> ![](/public/images/4-ETH-NFT-Game/section-1/1_5_6.png)

> 3 \. `Show test networks` を `ON` にする。
>
> ![](/public/images/4-ETH-NFT-Game/section-1/1_5_7.png)

> 4 \. `Rinkeby Test Network` を選択する。
>
> ![](/public/images/4-ETH-NFT-Game/section-1/1_5_8.png)
...
2. \. `YOUR_PRIVATE_RINKEBY_ACCOUNT_KEY` の取得
   ...
   > ![](/public/images/4-ETH-NFT-Game/section-1/1_5_9.png)
   >
   > 3\. `Account details` から `Export Private Key` をクリックしてください。
   > ![](/public/images/4-ETH-NFT-Game/section-1/1_5_10.png)
   >
   > 4\. MetaMask のパスワードを求められるので、入力したら `Confirm` を推します。
   > ![](/public/images/4-ETH-NFT-Game/section-1/1_5_11.png)
   >
   > 5\. あなたの秘密鍵（＝ `Private Key` ）が表示されるので、クリックしてコピーします。
   > ![](/public/images/4-ETH-NFT-Game/section-1/1_5_12.png)
   >
...
>
> - ユーザー名: 公開アドレス ![](/public/images/4-ETH-NFT-Game/section-1/1_5_13.png)
> - パスワード: 秘密鍵
>   ![](/public/images/4-ETH-NFT-Game/section-1/1_5_14.png)
>
...
![無題](/public/images/4-ETH-NFT-Game/section-1/1_5_15.png)
...
![](/public/images/4-ETH-NFT-Game/section-1/1_5_16.png)

キャラクターをクリックして、右下に表示されている `Properties` を確認してみましょう。

![](/public/images/4-ETH-NFT-Game/section-1/1_5_17.png)
