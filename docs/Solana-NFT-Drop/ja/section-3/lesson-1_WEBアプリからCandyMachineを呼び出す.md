...
最後に、Phantom WalletのネットワークをSolana Devnetに設定しましょう。

アプリケーション左上のメニューを開き、「Settings」に進みます。

![](/public/images/Solana-NFT-Drop/section-3/3_1_1.png)

「Developer Settings」に進み、`Testnet Mode`をオンにします。Solanaのテストネットが表示されるので、Devnetを選択します。

![](/public/images/Solana-NFT-Drop/section-3/3_1_2.png)
