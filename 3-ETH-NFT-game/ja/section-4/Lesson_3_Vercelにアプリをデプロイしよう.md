...
![](/public/images/3-ETH-NFT-game/section-4/4_3_4.png)
...
プロジェクトの完遂を証明する NFT を取得する条件は、以下のようになります。
